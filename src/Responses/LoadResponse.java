...
//    private List<Event> events = new ArrayList<Event>();
    public final static String INVALID_REQUEST_DATA = "Invalid request data (missing values, invalid values, etc.)";
     ...
     */
    public LoadResponse(int users, int persons, int events) {
        super(String.format("Successfully added %d users, " +
                        "%d persons, " +
                        "and %d events to the database.",
                users, persons, events), null);
    }
